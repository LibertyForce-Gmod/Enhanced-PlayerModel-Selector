...
function Menu.Setup()
	...
	Menu.AdvButton:SetPos( fw - 200, 3 )
	Menu.AdvButton:SetText( "#epms_visit_addon_page" )
	...
	Menu.ApplyButton:SetPos( fw - 560, 30 )
	Menu.ApplyButton:SetText( "#epms_apply_playermodel" )
	...
	Menu.ResetButton:SetPos( 5, fh - 25 )
	Menu.ResetButton:SetText( "#epms_reset" )
	...
	Menu.Right:SetSize( 430, 0 )
		...
		Menu.Right:AddSheet( "#smwidget.model", modeltab, "icon16/user.png" )
		
			local t = modeltab:Add( "DLabel" )
			t:SetPos( 129, 1 )
			--t:SetSize( 100, 20 )
			t:SetText( "#epms_search" )
			...
			modeltab:AddSheet( "#epms_icons", ModelScroll, "icon16/application_view_tile.png" )
			...
			modeltab:AddSheet( "#epms_table", ModelList, "icon16/application_view_list.png" )
			ModelList:DockMargin( 5, 0, 5, 5 )
			ModelList:Dock( FILL )
			ModelList:SetMultiSelect( false )
			ModelList:AddColumn( "#smwidget.model" )
			ModelList:AddColumn( "#epms_path" )
		...
		Menu.Right:AddSheet( "#epms_category_favorites", favorites, "icon16/star.png" )
		favorites:DockPadding( 8, 8, 8, 8 )
		
		local FavList = favorites:Add( "DListView" )
		FavList:Dock( FILL )
		FavList:SetMultiSelect( true )
		FavList:AddColumn( "#epms_favorites" )
		FavList:AddColumn( "#smwidget.model" )
		FavList:AddColumn( "#epms_skin" ):SetFixedWidth( 25 )
		FavList:AddColumn( "#smwidget.bodygroups" )
		...
		b:SetText( "#epms_load_selected_favourite" )
		b.DoClick = function()
		...
		b:SetPos( 0, 30 )
		b:SetSize( 125, 20 )
		b:SetText( "#epms_add_new_favorite" )
		b.DoClick = function()
		...
		b:SetPos( 135, 30 )
		b:SetSize( 125, 20 )
		b:SetText( "#epms_replace_selected" )
		b.DoClick = function()
			local sel = FavList:GetSelected()
		...
		b:SetPos( 270, 30 )
		b:SetSize( 125, 20 )
		b:SetText( "#epms_delete_all_selected" )
		b.DoClick = function()
			local sel = FavList:GetSelected()
		...
		local bgtab = Menu.Right:AddSheet( "#smwidget.bodygroups", bdcontrols, "icon16/group.png" )
		...
		local flextab = Menu.Right:AddSheet( "#epms_flexes", flexcontrols, "icon16/emoticon_wink.png" )
		...
		Menu.Right:AddSheet( "#smwidget.colors", controls, "icon16/color_wheel.png" )
		controls:DockPadding( 8, 8, 8, 8 )

		local lbl = controls:Add( "DLabel" )
		lbl:SetText( "#epms_player_color" )
		...
		local lbl = controls:Add( "DLabel" )
		lbl:SetText( "#epms_physgun_color" )
		lbl:SetTextColor( Color( 0, 0, 0, 255 ) )
		...
		b:Dock( TOP )
		b:SetSize( 150, 20 )
		b:SetText( "#epms_reset_to_default_values" )
		b.DoClick = function()
		...
		Menu.Right:AddSheet( "#smwidget.settings", moretab, "icon16/key.png" )
			
			
			local panel = moretab:Add( "DPanel" )
			moretab:AddSheet( "#epms_client", panel, "icon16/status_online.png" )
			...
			c:SetText( "#epms_enforce_your_playermodel" )
			c:SetDark( true )
			...
			t:SetAutoStretchVertical( true )
			t:SetText( "#epms_enforce_your_playermodel_tip" )
			t:SetDark( true )
			t:SetWrap( true )
			...
			c:DockMargin( 0, 0, 0, 5 )
			c:SetValue( GetConVar(c.cvar):GetBool() )
			c:SetText( "#epms_use_player_color_as_background" )
			c:SetDark( true )
			c:SizeToContents()
			c.OnChange = function( p, v )
				RunConsoleCommand( c.cvar, v == true and "1" or "0" )
			...
			t:DockMargin( 0, 0, 0, 20 )
			t:SetAutoStretchVertical( true )
			t:SetText( "#epms_use_player_color_as_background_tip" )
			t:SetDark( true )
			t:SetWrap( true )
			...
			c:DockMargin( 0, 0, 0, 5 )
			c:SetValue( GetConVar(c.cvar):GetBool() )
			c:SetText( "#epms_transparent_background" )
			c:SetDark( true )
			c:SizeToContents()
			c.OnChange = function( p, v )
				RunConsoleCommand( c.cvar, v == true and "1" or "0" )
			...
			t:DockMargin( 0, 0, 0, 20 )
			t:SetAutoStretchVertical( true )
			t:SetText( "#epms_transparent_background_tip" )
			t:SetDark( true )
			t:SetWrap( true )
			...
			c:DockMargin( 0, 0, 0, 5 )
			c:SetValue( GetConVar(c.cvar):GetBool() )
			c:SetText( "#epms_show_flexes_tab" )
			c:SetDark( true )
			c:SizeToContents()
			c.OnChange = function( p, v )
				RunConsoleCommand( c.cvar, v == true and "1" or "0" )
			...
			t:DockMargin( 0, 0, 0, 20 )
			t:SetAutoStretchVertical( true )
			t:SetText( "#epms_show_flexes_tab_tip" )
			t:SetDark( true )
			t:SetWrap( true )
			...
			b:SetHeight( 15 )
			b:SetText( "#epms_rebuild_spawn_icons" )
			b.DoClick = function()
			...
			t:DockMargin( 0, 0, 0, 20 )
			t:SetAutoStretchVertical( true )
			t:SetText( "#epms_rebuild_spawn_icons_tip" )
			t:SetDark( true )
			t:SetWrap( true )
			...
			if LocalPlayer():IsAdmin() then
				...
				local panel = moretab:Add( "DPanel" )
				moretab:AddSheet( "#epms_server", panel, "icon16/world.png" )
				panel:DockPadding( 10, 10, 10, 10 )
				...
				c:DockMargin( 0, 0, 0, 5 )
				c:SetValue( GetConVar(c.cvar):GetBool() )
				c:SetText( "#epms_enable_playermodel_enforcement" )
				c:SetDark( true )
				...
				t:DockMargin( 0, 0, 0, 20 )
				t:SetAutoStretchVertical( true )
				t:SetText( "#epms_enable_playermodel_enforcement_tip" )
				t:SetDark( true )
				t:SetWrap( true )
				...
				c:DockMargin( 0, 0, 0, 5 )
				c:SetValue( GetConVar(c.cvar):GetBool() )
				c:SetText( "#epms_allow_instant_changes" )
				c:SetDark( true )
				c.OnChange = ChangeCVar
				...
				t:DockMargin( 0, 0, 0, 20 )
				t:SetAutoStretchVertical( true )
				t:SetText( "#epms_allow_instant_changes_tip" )
				t:SetDark( true )
				t:SetWrap( true )
				...
				c:DockMargin( 0, 0, 0, 5 )
				c:SetValue( GetConVar(c.cvar):GetBool() )
				c:SetText( "#epms_allow_player_to_change_flexes" )
				c:SetDark( true )
				c.OnChange = ChangeCVar
				...
				t:DockMargin( 0, 0, 0, 20 )
				t:SetAutoStretchVertical( true )
				t:SetText( "#epms_allow_player_to_change_flexes_tip" )
				t:SetDark( true )
				t:SetWrap( true )
				...
				c:DockMargin( 0, 0, 0, 5 )
				c:SetValue( GetConVar(c.cvar):GetBool() )
				c:SetText( "#epms_enable_in_all_gamemodes" )
				c:SetDark( true )
				c.OnChange = ChangeCVar
				...
				t:DockMargin( 0, 0, 0, 20 )
				t:SetAutoStretchVertical( true )
				t:SetText( "#epms_enable_in_all_gamemodes_tip" )
				t:SetDark( true )
				t:SetWrap( true )
				...
				t:DockMargin( 0, 0, 0, 20 )
				t:SetAutoStretchVertical( true )
				t:SetText( "#epms_request_limit_tip" )
				t:SetDark( true )
				t:SetWrap( true )
				
				
				local panel = moretab:Add( "DPanel" )
				moretab:AddSheet( "#epms_gm_blacklist", panel, "icon16/delete.png" )
				panel:DockPadding( 10, 10, 10, 10 )
				...
				Blacklist:AddColumn( "#epms_blacklisted_gamemodes" )
				...
				t:DockMargin( 0, 0, 0, 20 )
				t:SetAutoStretchVertical( true )
				t:SetText( "#epms_gm_blacklist_tip" )
				t:SetDark( true )
				t:SetWrap( true )
				...
				b:SetHeight( 25 )
				b:SetText( "#epms_add_current_gamemode_to_blacklist" )
				b.DoClick = function()
				...
				b:DockMargin( 0, 0, 0, 20 )
				b:SetHeight( 20 )
				b:SetText( "#epms_manually_add_gamemode" )
				b.DoClick = function()
				...
				b:SetHeight( 25 )
				b:SetText( "#epms_remove_selected_gamemodes" )
				b.DoClick = function()
					local tbl = { }
				...
				if TFAVOX_Models then
					...
					local panel = moretab:Add( "DPanel" )
					moretab:AddSheet( "#epms_vox", panel, "icon16/sound.png" )
					panel:DockPadding( 10, 10, 10, 10 )
					...
					VOXlist:AddColumn( "#epms_playemodel" )
					VOXlist:AddColumn( "#epms_assigned_vox_pack" )
					...
					VOXinstalled:AddColumn( "#epms_available_vox_packs" )
					...
					b:SetWidth( 200 )
					b:SetText( "#epms_assing_vox_pack_to_current_playermodel" )
					b.DoClick = function()
					...
					--b:DockPadding( 100, 0, 100, 0 )
					b:SetWidth( 170 )
					b:SetText( "#epms_remove_selected_assigment" )
					b.DoClick = function()
						local tbl = { }
			...
			local panel = moretab:Add( "DPanel" )
			moretab:AddSheet( "#epms_info", panel, "icon16/information.png" )
	...
	function Menu.RebuildBodygroupTab()
		...
		if GetConVar( "sv_playermodel_selector_flexes" ):GetBool() and GetConVar( "cl_playermodel_selector_unlockflexes" ):GetBool() then
			...
			t:Dock( TOP )
			t:SetTall( 70 )
			t:SetText( "#epms_playermodel_flex_tip" )
			t:SetDark( true )
			t:SetWrap( true )
